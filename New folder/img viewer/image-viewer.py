...
class ImageView:
    ...
    def __init__(self, root):
        ...
        self.previous_button = Button(self.root, text="<", width=3, font=(
            'arial', 10, 'bold'), command=self.previous_image)
        self.previous_button.place(x=360, y=500)

        self.next_button = Button(self.root, text=">", width=3, font=(
            'arial', 10, 'bold'), command=self.next_image)
        self.next_button.place(x=455, y=500)

        self.open_button = Button(self.root, text="Open", width=5, font=(
